            ...
            <nav class="popup-window">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        echo '<form action="../auth/historial.php" method="POST">';
                ...
                if ($result_usuario !== null && $result_usuario->num_rows > 0) {
                    while ($row_usuario = $result_usuario->fetch_assoc()) {
                        ...
                        echo '<form action="../auth/editarInfo.php" method="POST">';
                ...
                if ($result_usuario !== null && $result_usuario->num_rows > 0) {
                    ...
                    <hr>
                    <li>
                        <button onclick="window.location.href = '../conexion/cerrarSesion.php';">
...
<div class="container" style="display: flex; ">
        ...
        if ($result !== null && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<img  src="../assets/images/hero-banner.png" width="200" height="200" />';
                ...
                echo '</div>';
                echo '<br>';
                echo '<form action="../conexion/pagos.php" method="POST">';
